...
ControlPanelComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ControlPanelComponent, selectors: [["app-control-panel"]], decls: 11, vars: 0, consts: [[1, "card", "ml-1", "my-pattern", 2, "position", "absolute", "top", "0", "right", "0", "bottom", "0", "left", "0"], ["cpanel", ""], [2, "background-color", "LightSteelBlue"], [1, "label_div"], [1, "label_text", 2, "font-size", "20px"], ["type", "checkbox", "id", "chkBoxShowNormalHouse", "name", "vehicle1", "value", "Bike"], [1, "label_text"]], template: function ControlPanelComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! /home/atif/Nemud/pv_ccr/lab-pv-system/lab-pv-system-v0000/src/main.ts */"./src/main.ts");
